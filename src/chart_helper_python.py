...
def decode(force_gold, sentence_len, label_scores_chart, is_train, gold, label_vocab):
    ...
    label_scores_for_span = None

    oracle_label_index = None
    label_score = None
    argmax_label_index = None
    left_score = None
    right_score = None

    best_split = None
    split_idx = None # Loop variable for splitting
    split_val = None # best so far
    max_split_val = None

    label_index_iter = None

    oracle_label_chart = None
    oracle_split_chart = None
